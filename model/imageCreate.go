...
var addr string = "https://spark-api.cn-huabei-1.xf-yun.com/v2.1/tti" 
var apiKey string = os.Getenv("APIKEY")
var apiSecret string = os.Getenv("APISecret")
var appid string = os.Getenv("APPID")


type ImageCreate_request struct { 
	Keyword string `json:"keyword"`
}

type ImageCreate_response struct {
...
func ImageCrate(request *ImageCreate_request) (string, error) {
	text :=  request.Keyword
	prompt := "请帮我画出一幅" + text + "的画"
	...
	// 保存图片
	ioutil.WriteFile("./resource/image/ttiDemo.jpg", image, 0777)
	imageURL := "http://127.0.0.1/resource/image/ttiDemo.jpg"
	return imageURL, nil
}
